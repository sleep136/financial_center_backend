...
# 学生收费库相关配置
student_expense_pgsql_url = 'mssql+pymssql://fc:123456@172.31.22.80:1433/xssf60?tds_version=7.0&charset=GB18030'
student_expense_engine = create_engine(student_expense_pgsql_url, echo=True)
#
